...
public:
	...
	/// param[info] Chip information object.
	bool getPartInfo(PartInfo& info);
	...
	/// Gets the current RSSI value of Modem
	/// \return RSSI value.
	int getRssiValue();
	...
	bool command(uint8_t cmd, const uint8_t* write_buf = 0, uint8_t write_len =
			0, uint8_t* read_buf = 0, uint8_t read_len = 0);
	...
	RHGenericDriver::RHMode getOnlineMode();
