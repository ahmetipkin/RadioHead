				0x3f, 0xee, 0xc8, 0xc7, 0xdb, 0xf2, 0x02, 0x08, 0x07, 0x03,
				0x15, 0xfc, 0x0f, 0x00, 0x3f, 0x2c, 0x0e, 0x04, 0x0c, 0x73, },

};

RH_RF24::RH_RF24(uint8_t slaveSelectPin, uint8_t interruptPin, uint8_t sdnPin,
		RHGenericSPI& spi) :
...
bool RH_RF24::getPartInfo(PartInfo& info) {
	uint8_t buf[8];
	...
	info.partBuild = buf[3];
	info.id = (buf[4] << 8) | buf[5];
	info.customer = buf[6];
	info.romId = buf[7];

	if (!command(RH_RF24_CMD_FUNC_INFO, 0, 0, buf, sizeof(buf)))
		return false;

	info.revExternal = buf[0];
	info.revBranch = buf[1];
	info.revInternal = buf[2];
	info.patch = (buf[3] << 8) | buf[4];
	info.func = buf[5];
...
bool RH_RF24::init() {
	...
	uint8_t int_ctl[] = {
	RH_RF24_MODEM_INT_STATUS_EN | RH_RF24_PH_INT_STATUS_EN, 0xff, 0xff, 0x00 };
	...
	set_properties(RH_RF24_PROPERTY_PKT_CONFIG1, pkt_config1,
			sizeof(pkt_config1));
	...
	RH_RF24_FIELD_CONFIG_CRC_START | RH_RF24_FIELD_CONFIG_SEND_CRC
			| RH_RF24_FIELD_CONFIG_CHECK_CRC | RH_RF24_FIELD_CONFIG_CRC_ENABLE };
	set_properties(RH_RF24_PROPERTY_PKT_FIELD_1_LENGTH_12_8, pkt_field1,
			sizeof(pkt_field1));
	/*
	 uint8_t tx_fifo_underload_limit[] = { 0x01 };
	 set_properties(RH_RF24_PROPERTY_PKT_TX_THRESHOLD, tx_fifo_underload_limit,
	 sizeof(tx_fifo_underload_limit));
	 */
	uint8_t pkt_field2[] = { 0x00, sizeof(_buf), 0x00,
	RH_RF24_FIELD_CONFIG_CRC_START | RH_RF24_FIELD_CONFIG_SEND_CRC
			| RH_RF24_FIELD_CONFIG_CHECK_CRC | RH_RF24_FIELD_CONFIG_CRC_ENABLE };
	set_properties(RH_RF24_PROPERTY_PKT_FIELD_2_LENGTH_12_8, pkt_field2,
			sizeof(pkt_field2));

	// Clear all other fields so they are never used, irrespective of the radio_config
	uint8_t pkt_fieldn[] = { 0x00, 0x00, 0x00, 0x00 };
	set_properties(RH_RF24_PROPERTY_PKT_FIELD_3_LENGTH_12_8, pkt_fieldn,
			sizeof(pkt_fieldn));
	set_properties(RH_RF24_PROPERTY_PKT_FIELD_4_LENGTH_12_8, pkt_fieldn,
			sizeof(pkt_fieldn));
	set_properties(RH_RF24_PROPERTY_PKT_FIELD_5_LENGTH_12_8, pkt_fieldn,
			sizeof(pkt_fieldn));
...
void RH_RF24::handleInterrupt() {
	uint8_t status[8];
	/*uint8_t cleaner[] = { 0, 0, 0 };
	 command(RH_RF24_CMD_GET_INT_STATUS, cleaner, sizeof(cleaner), status,
	 sizeof(status));
	 */
	command(RH_RF24_CMD_GET_INT_STATUS, 0, 0, status, sizeof(status));
	/*
...
//	if (status[4] & RH_RF24_INT_STATUS_INVALID_PREAMBLE)
	...
	if (status[0] & RH_RF24_INT_STATUS_PH_INT_STATUS) {
		...
		if (status[2] & RH_RF24_INT_STATUS_PACKET_RX) {
			...
			command(RH_RF24_CMD_GET_MODEM_STATUS, NULL, 0, modem_status,
					sizeof(modem_status));
...
int RH_RF24::getRssiValue() {
	byte buffer[9] = { 0 };

	if (!command(RH_RF24_CMD_GET_MODEM_STATUS, buffer, 1, buffer, 9)) {
		return 0;
	} else {
		return ((int) buffer[2] / 2) - 134;
	}
}

uint8_t RH_RF24::getChannel() const {
	return _channel;
}

void RH_RF24::setChannel(uint8_t channel) {
	_channel = channel;
}
...
bool RH_RF24::send(const uint8_t* data, uint8_t len) {
	...
	uint8_t totalLen = len + RH_RF24_HEADER_LEN;
	_buf[0] = totalLen;
	...
	set_properties(RH_RF24_PROPERTY_PKT_FIELD_2_LENGTH_7_0, &totalLen,
			sizeof(totalLen));
...
void RH_RF24::setPreambleLength(uint16_t bytes) {
	...
	RH_RF24_PREAMBLE_FIRST_1 | RH_RF24_PREAMBLE_LENGTH_BYTES
...
bool RH_RF24::setCRCPolynomial(CRCPolynomial polynomial) {
	if (polynomial >= CRC_NONE && polynomial <= CRC_Castagnoli) {
		// Caution this only has effect if CRCs are enabled
		uint8_t config[] = { (uint8_t) ((polynomial & RH_RF24_CRC_MASK)
				| RH_RF24_CRC_SEED_ALL_1S) };
		return set_properties(RH_RF24_PROPERTY_PKT_CRC_CONFIG, config,
				sizeof(config));
	} else
		return false;
}
...
bool RH_RF24::setFrequency(float centre, float afcPullInRange) {
	...
	uint8_t freq_control[] = { (uint8_t) n, (uint8_t) m2, (uint8_t) m1,
			(uint8_t) m0 };
...
void RH_RF24::setModeRx() {
	if (_mode != RHModeRx) {
		...
		uint8_t rx_config[] = { _channel,
		RH_RF24_CONDITION_RX_START_IMMEDIATE, 0x00, 0x00, _idleMode, _idleMode,
				_idleMode };
...
void RH_RF24::setModeTx() {
	if (_mode != RHModeTx) {
		...
		uint8_t tx_params[] = { _channel, (uint8_t) ((_idleMode << 4)
...
void RH_RF24::setTxPower(uint8_t power) {
	...
	uint8_t power_properties[] = { pa_mode, 0x00, 0x00 }; // PA_MODE from WDS sugggestions (why?)
...
RH_RF24_CMD_PART_INFO, 8 }, { RH_RF24_CMD_FUNC_INFO, 6 }, {
RH_RF24_CMD_GPIO_PIN_CFG, 7 }, { RH_RF24_CMD_FIFO_INFO, 2 }, {
RH_RF24_CMD_PACKET_INFO, 2 }, { RH_RF24_CMD_GET_INT_STATUS, 8 }, {
RH_RF24_CMD_GET_PH_STATUS, 2 }, { RH_RF24_CMD_GET_MODEM_STATUS, 8 }, {
RH_RF24_CMD_GET_CHIP_STATUS, 3 }, { RH_RF24_CMD_REQUEST_DEVICE_STATE, 2 }, };
...
RHGenericDriver::RHMode RH_RF24::getOnlineMode() {
	uint8_t status[] = { 0, 0 };
	command(RH_RF24_CMD_REQUEST_DEVICE_STATE, NULL, 0, status, sizeof(status));
